...
class OutcomeTrend extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <EMetric title="Outcome" value={currentValue} icon="fa-usd" iconDark>
        ...
        <div className="mt-3 position-relative">
          <EChart type="bar" data={currentData} options={chartOptions} height={this.props.height}/>
        </div>
      </EMetric>
    )
  }
