...
import ETable from 'elements/index'
    ...
    const columns = [
      {
        ...
        headerFormatter: (column, index) => (
          <div className="custom-control custom-control-inline custom-control-nameless custom-checkbox m-0">
            <input
              type="checkbox"
        ...
        formatter: (selected, row, index) => (
          <div className="custom-control custom-control-inline custom-checkbox custom-control-nameless m-0">
            <input
              ...
              onChange={(e) => this.handleSelect(row.id, e.target.checked)} />
              ...
              <div className="col">
                ...
                <div className="px-2">
                  <div className="custom-control custom-checkbox m-0">
                    ...
                    <label className="custom-control-label" htmlFor="actives-check">Actives Only</label>
                  </div>
                </div>
